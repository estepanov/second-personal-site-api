...
export const statsOverview: APIGatewayProxyHandler = async () => {
  try {
...
export const recentMatches: APIGatewayProxyHandler = async () => {
  try {
...
export const pvpOverview: APIGatewayProxyHandler = async () => {
  try {
...
export const comparePvpOverview: APIGatewayProxyHandler = async (event: APIGatewayEvent) => {
  try {
    ...
    const meCachedResults = await meCache.get();
    let meStats = {};
    if (!meCachedResults) {
    ...
    const tagCachedResults = await tagCache.get();
